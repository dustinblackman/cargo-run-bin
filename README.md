...
| index            | `String`      | false    | An URL of the registry index to use. Corresponds to the `cargo install` [`--index`](https://doc.rust-lang.org/cargo/commands/cargo-install.html#install-options) argument.                                                                                                |
| registry         | `String`      | false    | A name of the registry to use. Corresponds to the `cargo install` [`--registry`](https://doc.rust-lang.org/cargo/commands/cargo-install.html#install-options) argument.                                                                                                   |
